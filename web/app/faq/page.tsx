...
const ITEMS = [
  ...
  },
  {
    ...
    a: "macOS, Windows, and Linux installers are on GitHub Releases as v0.1.0-pre.3 (Arbor.dmg, Arbor.msi, Arbor.AppImage). On macOS, if Gatekeeper says the app is damaged, run xattr -cr /Applications/Arbor.app then open it. You can also clone arbor-cae and run npm run tauri.",
  },
];
