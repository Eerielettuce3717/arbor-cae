...
/** Demo graph used when running the Vite UI outside Tauri. */
export function mockBranchGraph(): BranchGraph {
  const projectId = "demo-project";
  const mainId = "br-main";
  const featId = "br-feat";
  const c0 = {
    id: "c0",
    projectId,
    branchId: mainId,
  ...
  const c1 = {
    ...
    parentId: "c0",
    mergeParentId: null,
    message: "Add bracket plate extrude",
    authorId: "u1",
    authorName: "You",
  ...
  const c2 = {
    ...
    parentId: "c1",
    mergeParentId: null,
    message: "Prototype shaft collar clearance",
    authorId: "u2",
    authorName: "A. Chen",
  ...
  const c4 = {
    ...
    parentId: "c3",
    mergeParentId: "c2",
    message: "Merge feature/clearance into main",
    authorId: "u1",
    authorName: "You",
    ...
    branches: [
      {
        ...
        updatedAt: c4.createdAt,
      },
      {
        id: featId,
        projectId,
        name: "feature/clearance",
        headCommitId: "c2",
        isDefault: false,
        isProtected: false,
        createdAt: c2.createdAt,
        updatedAt: c2.createdAt,
      },
    ],
    nodes: [
      { commit: c0, branchName: "main", column: 0 },
      { commit: c1, branchName: "main", column: 0 },
      { commit: c2, branchName: "feature/clearance", column: 1 },
      { commit: c3, branchName: "main", column: 0 },
      { commit: c4, branchName: "main", column: 0 },
    ],
    edges: [
      { fromId: "c0", toId: "c1", kind: "parent" },
      { fromId: "c1", toId: "c2", kind: "parent" },
      { fromId: "c1", toId: "c3", kind: "parent" },
      { fromId: "c3", toId: "c4", kind: "parent" },
      { fromId: "c2", toId: "c4", kind: "merge" },
    ],
  };
}
